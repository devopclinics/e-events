from .community import navigation_markup, render as render_community
...
.preview{{background:#25143c;color:white;text-align:center;padding:.6rem;font-weight:700}}nav{{display:flex;align-items:center;gap:1.4rem;padding:1.1rem max(5vw,24px);background:white}}nav b{{font-size:1.2rem;margin-right:auto}}nav span{{color:#60706c}}.site-links,.footer-links{{display:flex;gap:1rem;align-items:center}}.site-links a,.footer-links a{{text-decoration:none;font-weight:700;font-size:.86rem}}
