...
const WORDING_FIELDS = [
  ...
  ['firstNameLabel', 'RSVP form: first name field label', ''],
  ['lastNameLabel', 'RSVP form: last name field label', ''],
  ['emailLabel', 'RSVP form: email field label', ''],
  ['phoneLabel', 'RSVP form: phone field label', ''],
