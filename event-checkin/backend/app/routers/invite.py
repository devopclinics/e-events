...
async def _invite_page_out(event: Event, db: AsyncSession) -> InvitePageOut:
    ...
    return InvitePageOut(
        ...
        event_time_tbd=event.event_time_tbd,
        rsvp_require_approval=event.rsvp_require_approval,
        ...
        rsvp_invitee_type_options=event.rsvp_invitee_type_options,
        rsvp_invitee_age_options=event.rsvp_invitee_age_options,
        rsvp_count=count,
        ...
        partner_enabled=event.partner_enabled,
        partner_token=event.partner_token,
