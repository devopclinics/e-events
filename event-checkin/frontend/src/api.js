...
export const api = {
  ...
  festiomeUpdateChannel: (id, data) => festiomeReq('PATCH', `/festiome/v1/channels/${id}`, data),
  ...
  festiomeConnections: (groupId) => festiomeReq('GET', `/festiome/v1/groups/${groupId}/connections`),
  festiomeRequestConnection: (groupId, memberId) => festiomeReq('POST', `/festiome/v1/groups/${groupId}/connections/${memberId}`, {}),
  festiomeDecideConnection: (connectionId, status) => festiomeReq('PATCH', `/festiome/v1/connections/${connectionId}`, { status }),
  festiomeMeetups: (groupId, includePast = false) => festiomeReq('GET', `/festiome/v1/groups/${groupId}/meetups${includePast ? '?include_past=true' : ''}`),
  festiomeCreateMeetup: (groupId, data) => festiomeReq('POST', `/festiome/v1/groups/${groupId}/meetups`, data),
  festiomeUpdateMeetup: (meetupId, data) => festiomeReq('PATCH', `/festiome/v1/meetups/${meetupId}`, data),
  festiomeRsvpMeetup: (meetupId, status) => festiomeReq('POST', `/festiome/v1/meetups/${meetupId}/rsvp`, { status }),
  festiomeCommunityOverview: (groupId) => festiomeReq('GET', `/festiome/v1/groups/${groupId}/community-overview`),
