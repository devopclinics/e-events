...
PLAN_DESCRIPTIONS = {
    ...
    "addon_engagement": "Live quizzes, polls, surveys, and feedback guests join from their phone — with a presenter control screen and a TV/projector display.",
...
ADDON_CAPABILITIES = {
    ...
    "addon_engagement": ["Live quizzes & polls", "Presenter control screen", "TV/projector display"],
