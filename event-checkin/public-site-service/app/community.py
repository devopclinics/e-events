...
def _programme_date_label(start, end):
    ...
    for start_format in ("%B %d, %Y", "%b %d, %Y"):
        try:
            ...
            start_date = None
    if start_date:
        for end_format in ("%B %d, %Y", "%B %d", "%b %d, %Y", "%b %d"):
            try:
