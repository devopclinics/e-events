...
export const PDFS = [
  ...
  },
  {
    ...
    filename: 'festio-intro-target-audience.pdf',
    type: 'PDF',
  },
  {
    title: 'Festio One-Pager',
    description: 'Compact sales handout for quick sharing. Rebranded and regenerated 2026-09-12 (was still "EventQR" throughout, including the domain and logo mark) — its HTML source below is now the source of truth; print that page to regenerate this PDF.',
    href: '/media/festio-onepager.pdf',
    filename: 'festio-onepager.pdf',
    type: 'PDF',
  },
  {
    ...
    href: '/media/festio-pitch.pdf',
    filename: 'festio-pitch.pdf',
    type: 'PDF',
  },
]
...
export const HTML_ASSETS = [
  ...
  },
  {
    ...
    href: '/media/festio-onepager.html',
    filename: 'festio-onepager.html',
    type: 'HTML',
  },
  {
    title: 'Competitor Pricing Strategy Review (2026-07)',
  ...
  },
  {
    ...
    description: 'Interactive browser-based tour for prospects and new organizers. Refreshed 2026-07-15 for the "email is always free" claim, the dead-end Full Guide link, and 2 new steps for invitation categories/auto-seating and FestioHub. Re-audited 2026-09-12: the 2026-07-15 pass hadn\'t actually caught the "EventQR"/events.vsgs.io branding throughout (title, logo marks, every mock URL, the voiceover script) — fixed for real this time.',
  ...
  },
  {
    ...
    href: '/media/festio-pitch-v3-target-audience.html',
    filename: 'festio-pitch-v3-target-audience.html',
    type: 'HTML',
  },
  {
